...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +970 59 80 82 086</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> feras@gmail.com</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2021 komboz. All rights reserved.</p>
					<p class="pull-right">Development by <span><a target="_blank" href="#">Feras A. Abu Alkomboz</a></span></p>
				</div>
			</div>
		</div>
